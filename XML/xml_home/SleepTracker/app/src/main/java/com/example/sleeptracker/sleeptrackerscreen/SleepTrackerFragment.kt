...
import com.example.sleeptracker.BR.sleepTrackerViewModel
...
class SleepTrackerFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewModel.showSnackBarEvent.observe(viewLifecycleOwner) {
            if (it == true) { // Observed state is true.
                Snackbar.make(
                    ...
                    Snackbar.LENGTH_SHORT).show() // How long to display the message.
        ...
        // Observe the new transformed list from the ViewModel
        viewModel.nightsWithHeader.observe(viewLifecycleOwner) { items ->
            // Now you can just call submitList directly
